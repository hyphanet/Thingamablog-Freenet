...
public class WysiwygHTMLEditorKit extends HTMLEditorKit
{
    ...
    public class WysiwygHTMLFactory extends HTMLFactory
    {
        ...
        {            
            ...
            if(o instanceof HTML.Tag)
            {
                ...
                {
                    return new InvisibleCommentView(super.create(elem));
                }
            }
    ...
    private class InvisibleCommentView extends DelegateView
    {
        public InvisibleCommentView(View delegate)
        {
            super(delegate);
        }
        
        public void paint(Graphics g, Shape a){}//dont paint anything
    }
}
