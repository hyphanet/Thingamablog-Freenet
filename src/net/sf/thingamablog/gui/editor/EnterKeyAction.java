 ...
 *
 */
public class EnterKeyAction extends TextAction
{    
        ...
        {            
            ...
            {                
                ...
                if(parentTag.equals(HTML.Tag.LI))               
                {
                    ...
                    else// empty list item
                    {
                        ...
                        System.err.println(listParentElem.getName());
                        
                        if(isListItem(HTML.getTag(listParentElem.getName())))//nested list
                        {                           
                            //document.insertAfterEnd(listParentElem, toListItem("zz"));
                            ...
                            HTMLEditorKit.InsertHTMLTextAction a = 
                                ...
                                "<li></li>", HTML.getTag(listParentElem.getParentElement().getName()), HTML.Tag.LI);                            
                            a.actionPerformed(e);
                ...
                {
                    System.err.println("IMPLIED DEFAULT");
                    System.err.println("elem: " + elem.getName());
                    System.err.println("pelem: " + parentElem.getName());                    
                    ...
                    {
                        System.err.println("insertParagraphAfter elem"); 
                        insertParagraphAfter(elem, editor);
                    }
                    else
                    {
                        System.err.println("***insertParagraphAfter parentElem");
            ...
            {                
                ...
                if(isListItem(tag))
                {
                    ...
                    {                
                        System.err.println("NOT implied delegate");
                        delegate.actionPerformed(e);
                    }
                }
                else 
                {
                    System.err.println("not implied insertparaafter1 " + elem.getName());
                    insertParagraphAfter(elem, editor);
                }
            }
        }
    ...
    throws Exception
    {
        System.err.println("enclosing in div: " + elem.getName());
        HTML.Tag tag = HTML.getTag(elem.getName());
