...
public class JAboutBox extends JDialog
{
	...
	private JButton closeButton = new JButton(Messages.getString("JAboutBox.Close"));  //$NON-NLS-1$
   ...
   */
	...
	{	    
		...
		tabs.addTab(Messages.getString("JAboutBox.About"), aboutPanel);  //$NON-NLS-1$
 
		tabs.addTab(Messages.getString("JAboutBox.Authors"), new JScrollPane(authorPanel));  //$NON-NLS-1$
		
		if(showThanks) 
			tabs.addTab(Messages.getString("JAboutBox.Thanks_To"), new JScrollPane(thanksPanel)); //$NON-NLS-1$

		licenseTextArea.setEditable(false);
		readLicense(license);
		tabs.addTab(Messages.getString("JAboutBox.License_Agreement"), new JScrollPane(licenseTextArea)); //$NON-NLS-1$
