...
public class TBCategoriesPanel extends PropertyPanel
{
	...
	public TBCategoriesPanel(TBWeblog wb)
	{
		...
		limitCatEntriesCb = new JCheckBox(Messages.getString("TBCategoriesPanel.Limit_category_page")); //$NON-NLS-1$
        ...
        genCatFeedsCb = new JCheckBox(Messages.getString("TBCategoriesPanel.Generate_category_feeds")); //$NON-NLS-1$
		...
		oldestFirstCb = new JCheckBox(Messages.getString("TBCategoriesPanel.Generate_oldest_entries_first")); //$NON-NLS-1$
		...
		lip.addItem(Messages.getString("TBCategoriesPanel.Category_pages_extension"), spacer); //$NON-NLS-1$
        ...
        spacer.add(new JPanel(), BorderLayout.CENTER);
        lip1.addItem(Messages.getString("TBCategoriesPanel.Category_feeds_extension"), spacer); 
