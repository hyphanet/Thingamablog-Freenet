...
public class EditableList extends JPanel
{
	...
	public EditableList(EditableListModel m)
	{
		...
		addButton = new JButton(Messages.getString("EditableList.Add")); //$NON-NLS-1$
		addButton.addActionListener(listener);
		removeButton = new JButton(Messages.getString("EditableList.Remove")); //$NON-NLS-1$
		removeButton.addActionListener(listener);
		editButton = new JButton(Messages.getString("EditableList.Edit")); //$NON-NLS-1$
