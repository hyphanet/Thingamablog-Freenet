...
{	
    ...
    private class VariableEditor extends StandardDialog
    {
    	...
    	private String title = Messages.getString("TBCustomVariablesPanel.Variable_Editor"); //$NON-NLS-1$
    	...
    	{    		    		
    		...
    		TextEditPopupManager popper = new TextEditPopupManager();
    		popper.addJTextComponent(varNameField);
    		popper.addJTextComponent(textArea);
    		    		
    		JPanel namePanel = new JPanel(new BorderLayout());
    		namePanel.add(new JLabel(Messages.getString("TBCustomVariablesPanel.Name")), BorderLayout.NORTH); //$NON-NLS-1$
    		namePanel.add(varNameField, BorderLayout.CENTER);
    		
    		JPanel valuePanel = new JPanel(new BorderLayout());
    		valuePanel.add(new JLabel(Messages.getString("TBCustomVariablesPanel.Value")), BorderLayout.NORTH); //$NON-NLS-1$
    	...
    	public boolean isValidData()
    	{
    		...
    		if(s.length() == 0)
    		{
				JOptionPane.showMessageDialog(VariableEditor.this, 
					Messages.getString("TBCustomVariablesPanel.no_name_prompt"), //$NON-NLS-1$
					Messages.getString("TBCustomVariablesPanel.Invalid_Variable"), JOptionPane.WARNING_MESSAGE); //$NON-NLS-1$
				return false;
    		}
    		...
    		{
				JOptionPane.showMessageDialog(VariableEditor.this, 
					Messages.getString("TBCustomVariablesPanel.no_value_prompt"), //$NON-NLS-1$
					Messages.getString("TBCustomVariablesPanel.Invalid_Variable"), JOptionPane.WARNING_MESSAGE); //$NON-NLS-1$
				return false;
    		}
    		...
    		for(int i = 0; i < s.length(); i++)
    		{
    			...
    			{
    				JOptionPane.showMessageDialog(VariableEditor.this, 
    					Messages.getString("TBCustomVariablesPanel.invalid_variable_name_prompt"), //$NON-NLS-1$
    					Messages.getString("TBCustomVariablesPanel.Invalid_Variable"), JOptionPane.WARNING_MESSAGE); //$NON-NLS-1$
