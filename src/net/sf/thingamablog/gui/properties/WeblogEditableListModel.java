...
public class WeblogEditableListModel implements EditableListModel
{
	...
	public boolean shouldRemove(Object o, EditableList c)
	{
		int r = JOptionPane.showConfirmDialog(c,
			Messages.getString("WeblogEditableListModel.Remove") + " : " + o.toString(), Messages.getString("WeblogEditableListModel.Confirm"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    {
		String s = JOptionPane.showInputDialog(c, Messages.getString("WeblogEditableListModel.Enter_a_category"), Messages.getString("WeblogEditableListModel.Add_Category"), //$NON-NLS-1$ //$NON-NLS-2$
	...
	{
		String prompt = Messages.getString("WeblogEditableListModel.category_rename_prompt"); //$NON-NLS-1$
		Object newo = JOptionPane.showInputDialog(c, prompt, Messages.getString("WeblogEditableListModel.Rename"), //$NON-NLS-1$
	...
	private Object addAuthor(EditableList c)
	{
		...
		int r = JOptionPane.showConfirmDialog(
			c, aep, Messages.getString("WeblogEditableListModel.Add_Author"), //$NON-NLS-1$
	...
	private Object editAuthor(Object o, EditableList c)
	{
		...
		int r = JOptionPane.showConfirmDialog(
			c, aep, Messages.getString("WeblogEditableListModel.Edit_Author"), //$NON-NLS-1$
			JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
	...
	private class AuthorEditPane extends LabelledItemPanel
	{
		...
		{			
			addItem(Messages.getString("WeblogEditableListModel.Name"), aNameField); //$NON-NLS-1$
			addItem(Messages.getString("WeblogEditableListModel.Email"), aEmailField); //$NON-NLS-1$
			addItem(Messages.getString("WeblogEditableListModel.URL"), aUrlField); //$NON-NLS-1$
