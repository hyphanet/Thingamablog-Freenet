...
public class FeedPropertiesDialog extends StandardDialog
{
	...
	{
		super(parent, Messages.getString("FeedPropertiesDialog.Feed_Properties")); //$NON-NLS-1$
		this.feed = feed;
		init();
	...
	private void init()
	{
		...
		String updateStr = Messages.getString("FeedPropertiesDialog.Never"); //$NON-NLS-1$
		if(date != null)
		...
		lip.addItem(Messages.getString("FeedPropertiesDialog.Feed_Title"), titleField);		 //$NON-NLS-1$
		lip.addItem(Messages.getString("FeedPropertiesDialog.Feed_URL"), urlField);		 //$NON-NLS-1$
		lip.addItem(Messages.getString("FeedPropertiesDialog.Updated"), updateLabel); //$NON-NLS-1$
		lip.setBorder(new TitledBorder(Messages.getString("FeedPropertiesDialog.Feed"))); //$NON-NLS-1$
		
		LabelledItemPanel lip1 = new LabelledItemPanel();
		lip1.addItem(Messages.getString("FeedPropertiesDialog.Limit_Headlines"), arcCheckBox); //$NON-NLS-1$
		...
		lip1.addItem(Messages.getString("FeedPropertiesDialog.Max_Headlines"), spinPanel); //$NON-NLS-1$
		lip1.setBorder(new TitledBorder(Messages.getString("FeedPropertiesDialog.Archiving"))); //$NON-NLS-1$
