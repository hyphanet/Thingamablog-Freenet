...
public class FeedTableModel extends DefaultSortTableModel
{
	...
	public static final Object ITEM = Messages.getString("FeedTableModel.Item"); //$NON-NLS-1$
	
	public static final Object DATE = Messages.getString("WeblogTableModel.Date_Posted");;
	//public static final Object RETRIEVED = Messages.getString("FeedTableModel.Retrieved"); //$NON-NLS-1$
