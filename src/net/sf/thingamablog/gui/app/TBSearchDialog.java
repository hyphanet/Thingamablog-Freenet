...
{
	private final String DRAFTS = Messages.getString("TBSearchDialog.Drafts"); //$NON-NLS-1$
	private final String POSTS = Messages.getString("TBSearchDialog.Posts"); //$NON-NLS-1$
	private final String CREATED = Messages.getString("TBSearchDialog.Created"); //$NON-NLS-1$
	private final String MODIFIED = Messages.getString("TBSearchDialog.Modified"); //$NON-NLS-1$
	private final String ALL_CATS = Messages.getString("TBSearchDialog.All_Categories"); //$NON-NLS-1$
	
	public static final String ENTRIES_TAB = Messages.getString("TBSearchDialog.Entries"); //$NON-NLS-1$
	public static final String ITEMS_TAB = Messages.getString("TBSearchDialog.Feed_Items"); //$NON-NLS-1$
	...
	private JLabel status = new JLabel(Messages.getString("TBSearchDialog.Ready")); //$NON-NLS-1$
	...
	private void init(WeblogList list, FeedFolder root)
	{
		...
		setTitle(Messages.getString("TBSearchDialog.Search")); //$NON-NLS-1$
		...
		includeSubsCb = new JCheckBox(Messages.getString("TBSearchDialog.Include_subfolders")); //$NON-NLS-1$
		...
		findButton = new JButton(Messages.getString("TBSearchDialog.Find")); //$NON-NLS-1$
		findButton.setMnemonic('F');
		closeButton = new JButton(Messages.getString("TBSearchDialog.Close"));		 //$NON-NLS-1$
		...
		lip.addItem(Messages.getString("TBSearchDialog.In_Site"), weblogBox);		 //$NON-NLS-1$
		p = new JPanel(new BorderLayout());
		p.add(postTypeBox, BorderLayout.WEST);
		p.add(new JPanel(), BorderLayout.CENTER);		
		lip.addItem(Messages.getString("TBSearchDialog.Find"), p);		 //$NON-NLS-1$
		lip.addItem(Messages.getString("TBSearchDialog.Title_contains"), titleField); //$NON-NLS-1$
		lip.addItem(Messages.getString("TBSearchDialog.Body_contains"), entryField); //$NON-NLS-1$
		lip.addItem(Messages.getString("TBSearchDialog.In_category"), catBox); //$NON-NLS-1$
		...
		lip.addItem(Messages.getString("TBSearchDialog.Look_in_folder"), p); //$NON-NLS-1$
		lip.addItem("", includeSubsCb); //$NON-NLS-1$
		lip.addItem(Messages.getString("TBSearchDialog.Title_contains"), feedTitleField); //$NON-NLS-1$
		lip.addItem(Messages.getString("TBSearchDialog.Body_contains"), feedDescField); //$NON-NLS-1$
		...
		datePanel.add(Box.createHorizontalStrut(10));
		lip.addItem(Messages.getString("TBSearchDialog.Updated_Between"), datePanel); //$NON-NLS-1$
	...
	public BlogEntry[] performWeblogSearch() throws BackendException
	{
		...
		String str = Messages.getString("TBSearchDialog.Entries_Found") + ": " + be.length; //$NON-NLS-1$ //$NON-NLS-2$
		status.setText(str);
		return be;
	}
	...
	public FeedItem[] performFeedSearch() throws FeedBackendException
	{
		...
		String str = Messages.getString("TBSearchDialog.Items_Found") + ": " + items.length; //$NON-NLS-1$ //$NON-NLS-2$
		status.setText(str);
		return items;
	}
	...
	private class FolderChooserDialog extends StandardDialog
	{
		...
		{
			super(owner, Messages.getString("TBSearchDialog.Select_Folder")); //$NON-NLS-1$
