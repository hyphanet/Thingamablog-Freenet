...
public class StandardDialog extends JDialog
{
    ...
    private void init(int orientation, int spacing)
    {
        ...
        Action okAction = new AbstractAction(Messages.getString("StandardDialog.OK"))
        {
        ...
        Action cancelAction = new AbstractAction(Messages.getString("StandardDialog.Cancel")) //$NON-NLS-1$
        {
            public void actionPerformed(ActionEvent actionEvent)
            {
