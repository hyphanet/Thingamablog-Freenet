...
public class ImageViewerDialog extends JDialog
{
	...
	private JToolBar createToolBar()
	{
		...
		Utils.addToolbarButton(toolBar, new BestFitAction());
		Utils.addToolbarButton(toolBar, new ActualSizeAction());
		toolBar.addSeparator();
		Utils.addToolbarButton(toolBar, new ZoomInAction());
		Utils.addToolbarButton(toolBar, new ZoomOutAction());
		return toolBar;
	}
	...
	private class BestFitAction extends AbstractAction
	{
		...
		{
			super(Messages.getString("ImageViewerDialog.Best_Fit"), Utils.createIcon(RES + "bestfit.gif")); //$NON-NLS-1$ //$NON-NLS-2$
		}
	...
	private class ActualSizeAction extends AbstractAction 
	{
		...
		{
			super(Messages.getString("ImageViewerDialog.Actual_Size"), Utils.createIcon(RES + "actual.gif")); //$NON-NLS-1$ //$NON-NLS-2$
		}
	...
	private class ZoomInAction extends AbstractAction 
	{
		public ZoomInAction() 
		{
			super(Messages.getString("ImageViewerDialog.Zoom_In"), Utils.createIcon(RES + "zoomin.png"));			      	 //$NON-NLS-1$ //$NON-NLS-2$
		}
	...
	private class ZoomOutAction extends AbstractAction 
	{
		...
		{
			super(Messages.getString("ImageViewerDialog.Zoom_Out"), Utils.createIcon(RES + "zoomout.png")); //$NON-NLS-1$ //$NON-NLS-2$
		}
