...
public class TBAbout
{
	public static void showAboutBox(Frame f)
	{
		...
		ab.setAppIcon(Utils.createIcon(TBGlobals.RESOURCES + "icon32.gif")); //$NON-NLS-1$
		...
		ab.addContributor("Steven Ostermiller\n" +  //$NON-NLS-1$
			"http://ostermiller.org/utils/Browser.html\n" + //$NON-NLS-1$
			"Browser Opener"); //$NON-NLS-1$
		...
		ab.addContributor("Memoranda Project\n" +
		    "http://memoranda.sf.net\nVarious bits of WYSIWYG editor code");
		ab.addContributor("RText\n" +
	    "http://rtext.sf.net\nSyntax highlighting");
